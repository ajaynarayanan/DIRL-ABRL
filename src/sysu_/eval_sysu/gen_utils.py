...
def get_test_ids(file_name):
    test_id_filepath = osp.join(this_path, "./data_split/" + file_name + "_id.mat")
...
def get_cam_permutation_indices(all_cams):
    rand_cam_perm_filepath = osp.join(this_path, "./data_split/rand_perm_cam.mat")
